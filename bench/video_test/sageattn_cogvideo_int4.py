...
from src.core import sageattn_qk_int4_pv_fp16_triton as sageattn
...
logger = Logger(name="triton_sage_attn_int4", log_dir="logs", logging_mode=True)
logger.log(f"Time taken: {end_time - start_time} seconds, loss: {loss}")
diffusers.utils.export_to_video(video, "./video/cogvideo_sage_int4.mp4", fps=8)
