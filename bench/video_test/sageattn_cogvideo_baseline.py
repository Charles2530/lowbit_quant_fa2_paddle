...
logger = Logger(name="triton_sage_attn_baseline", log_dir="logs", logging_mode=True)
logger.log(f"Time taken: {end_time - start_time} seconds, loss: {loss}")
diffusers.utils.export_to_video(video, "./video/cogvideo_sage_baseline.mp4", fps=8)
